...
IFontDisp = Font
__all__ = [ 'IPicture', 'OLE_XPOS_PIXELS', 'OLE_YSIZE_HIMETRIC',
           'FONTUNDERSCORE', 'Unchecked', 'OLE_TRISTATE', 'Gray',
           'OLE_XPOS_HIMETRIC', 'OLE_OPTEXCLUSIVE', 'Checked',
           'FONTBOLD', 'FONTITALIC', 'OLE_XSIZE_PIXELS',
           'OLE_YPOS_PIXELS', 'OLE_YPOS_HIMETRIC', 'Picture',
           'IFontEventsDisp', 'OLE_YPOS_CONTAINER', 'FONTSIZE',
           'IFont', 'OLE_YSIZE_CONTAINER', 'StdPicture', 'VgaColor',
           'LoadPictureConstants', 'FONTNAME', 'FONTSTRIKETHROUGH',
           'FontEvents', 'Font', 'IFontDisp', 'OLE_ENABLEDEFAULTBOOL',
           'OLE_XSIZE_CONTAINER', 'OLE_XPOS_CONTAINER', 'StdFont',
           'Monochrome', 'OLE_COLOR', 'OLE_HANDLE', 'Default',
           'OLE_XSIZE_HIMETRIC', 'Color', 'OLE_CANCELBOOL',
           'OLE_YSIZE_PIXELS', 'IPictureDisp']
